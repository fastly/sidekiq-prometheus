...
* `init_label_sets`: Hash of metrics and label sets that are initialized by calling `[metric.init_label_set](https://github.com/prometheus/client_ruby/tree/e144d6225d3c346e9a4dd0a11f41f8acde386dd8#init_label_set)` after the metric is registered. `Hash{Symbol (metric name) => Array<Hash> (label sets)}`.
